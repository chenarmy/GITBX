...
const modalMessages: Record<Locale, MessageCatalog> = {
  en: {
    'Reset Branch to Commit': 'Reset Branch to Commit',
    'Target Commit:': 'Target Commit:',
    'Reset Type': 'Reset Type',
    'Soft (--soft)': 'Soft (--soft)',
    'Keep all changes staged in the index. No file changes are lost.': 'Keep all changes staged in the index. No file changes are lost.',
    'Mixed (--mixed, Default)': 'Mixed (--mixed, Default)',
    'Keep all working tree changes unstaged. Index is reset.': 'Keep all working tree changes unstaged. Index is reset.',
    'Hard (--hard)': 'Hard (--hard)',
    'Discard all working tree and staged changes. Irreversible!': 'Discard all working tree and staged changes. Irreversible!',
    'Reset': 'Reset',
    'Resetting...': 'Resetting...',
    "Merge into '{branch}'": "Merge into '{branch}'",
    'Source Branch to Merge': 'Source Branch to Merge',
    'Merge Strategy': 'Merge Strategy',
    'Default (Fast-forward if possible, otherwise merge commit)': 'Default (Fast-forward if possible, otherwise merge commit)',
    'Always create merge commit (--no-ff)': 'Always create merge commit (--no-ff)',
    'Squash merge (--squash)': 'Squash merge (--squash)',
    'Fast-forward only (--ff-only)': 'Fast-forward only (--ff-only)',
    'Custom Commit Message (Optional)': 'Custom Commit Message (Optional)',
    'Merging...': 'Merging...',
    "Merge '{branch}'": "Merge '{branch}'",
  },
  'zh-CN': {
    'Reset Branch to Commit': '重置分支到提交',
    'Target Commit:': '目标提交：',
    'Reset Type': '重置类型',
    'Soft (--soft)': '软重置 (--soft)',
    'Keep all changes staged in the index. No file changes are lost.': '保留所有暂存区更改，不丢失任何文件修改。',
    'Mixed (--mixed, Default)': '混合重置 (--mixed，默认)',
    'Keep all working tree changes unstaged. Index is reset.': '保留工作区修改为未暂存状态，重置暂存区。',
    'Hard (--hard)': '硬重置 (--hard)',
    'Discard all working tree and staged changes. Irreversible!': '丢弃所有工作区和暂存区更改，不可逆！',
    'Reset': '重置',
    'Resetting...': '正在重置…',
    "Merge into '{branch}'": "合并到 '{branch}'",
    'Source Branch to Merge': '要合并的来源分支',
    'Merge Strategy': '合并策略',
    'Default (Fast-forward if possible, otherwise merge commit)': '默认（可快进则快进，否则创建合并提交）',
    'Always create merge commit (--no-ff)': '始终创建合并提交 (--no-ff)',
    'Squash merge (--squash)': '压缩合并 (--squash)',
    'Fast-forward only (--ff-only)': '仅快进 (--ff-only)',
    'Custom Commit Message (Optional)': '自定义提交说明（可选）',
    'Merging...': '正在合并…',
    "Merge '{branch}'": "合并 '{branch}'",
  },
  ja: {
    'Reset Branch to Commit': 'ブランチをコミットにリセット',
    'Target Commit:': '対象コミット:',
    'Reset Type': 'リセットの種類',
    'Soft (--soft)': 'ソフト (--soft)',
    'Keep all changes staged in the index. No file changes are lost.': 'すべての変更をステージに残します。ファイル変更は失われません。',
    'Mixed (--mixed, Default)': 'ミックス (--mixed, デフォルト)',
    'Keep all working tree changes unstaged. Index is reset.': '作業ツリーの変更を未ステージとして保持します。インデックスはリセットされます。',
    'Hard (--hard)': 'ハード (--hard)',
    'Discard all working tree and staged changes. Irreversible!': '作業ツリーとステージの変更をすべて破棄します。元に戻せません！',
    'Reset': 'リセット',
    'Resetting...': 'リセット中…',
    "Merge into '{branch}'": "「{branch}」にマージ",
    'Source Branch to Merge': 'マージ元のブランチ',
    'Merge Strategy': 'マージ戦略',
    'Default (Fast-forward if possible, otherwise merge commit)': 'デフォルト (可能な場合はファストフォワード、それ以外はマージコミット)',
    'Always create merge commit (--no-ff)': '常にマージコミットを作成 (--no-ff)',
    'Squash merge (--squash)': 'スカッシュマージ (--squash)',
    'Fast-forward only (--ff-only)': 'ファストフォワードのみ (--ff-only)',
    'Custom Commit Message (Optional)': 'カスタムコミットメッセージ (任意)',
    'Merging...': 'マージ中…',
    "Merge '{branch}'": "「{branch}」をマージ",
  },
  de: {
    'Reset Branch to Commit': 'Branch auf Commit zurücksetzen',
    'Target Commit:': 'Ziel-Commit:',
    'Reset Type': 'Reset-Typ',
    'Soft (--soft)': 'Soft (--soft)',
    'Keep all changes staged in the index. No file changes are lost.': 'Alle Änderungen im Index behalten. Keine Dateiänderungen gehen verloren.',
    'Mixed (--mixed, Default)': 'Mixed (--mixed, Standard)',
    'Keep all working tree changes unstaged. Index is reset.': 'Arbeitsbaumänderungen ungestaged lassen. Index wird zurückgesetzt.',
    'Hard (--hard)': 'Hard (--hard)',
    'Discard all working tree and staged changes. Irreversible!': 'Alle Arbeitsbaum- und Staging-Änderungen verwerfen. Unwiderruflich!',
    'Reset': 'Zurücksetzen',
    'Resetting...': 'Wird zurückgesetzt…',
    "Merge into '{branch}'": "In „{branch}“ mergen",
    'Source Branch to Merge': 'Quell-Branch zum Mergen',
    'Merge Strategy': 'Merge-Strategie',
    'Default (Fast-forward if possible, otherwise merge commit)': 'Standard (Fast-Forward wenn möglich, sonst Merge-Commit)',
    'Always create merge commit (--no-ff)': 'Immer Merge-Commit erstellen (--no-ff)',
    'Squash merge (--squash)': 'Squash-Merge (--squash)',
    'Fast-forward only (--ff-only)': 'Nur Fast-Forward (--ff-only)',
    'Custom Commit Message (Optional)': 'Eigene Commit-Nachricht (optional)',
    'Merging...': 'Wird gemergt…',
    "Merge '{branch}'": "„{branch}“ mergen",
  },
  es: {
    'Reset Branch to Commit': 'Restablecer rama a commit',
    'Target Commit:': 'Commit objetivo:',
    'Reset Type': 'Tipo de restablecimiento',
    'Soft (--soft)': 'Suave (--soft)',
    'Keep all changes staged in the index. No file changes are lost.': 'Mantener todos los cambios preparados en el índice. No se pierde ningún cambio.',
    'Mixed (--mixed, Default)': 'Mixto (--mixed, Predeterminado)',
    'Keep all working tree changes unstaged. Index is reset.': 'Mantener cambios en el árbol de trabajo sin preparar. Se restablece el índice.',
    'Hard (--hard)': 'Fuerte (--hard)',
    'Discard all working tree and staged changes. Irreversible!': 'Descartar todos los cambios preparados y de trabajo. ¡Irreversible!',
    'Reset': 'Restablecer',
    'Resetting...': 'Restableciendo…',
    "Merge into '{branch}'": "Fusionar en «{branch}»",
    'Source Branch to Merge': 'Rama de origen a fusionar',
    'Merge Strategy': 'Estrategia de fusión',
    'Default (Fast-forward if possible, otherwise merge commit)': 'Predeterminado (Avance rápido si es posible, de lo contrario commit de fusión)',
    'Always create merge commit (--no-ff)': 'Crear siempre commit de fusión (--no-ff)',
    'Squash merge (--squash)': 'Fusión combinada (--squash)',
    'Fast-forward only (--ff-only)': 'Solo avance rápido (--ff-only)',
    'Custom Commit Message (Optional)': 'Mensaje de commit personalizado (opcional)',
    'Merging...': 'Fusionando…',
    "Merge '{branch}'": "Fusionar «{branch}»",
  },
  'zh-TW': {
    'Reset Branch to Commit': '重設分支到提交',
    'Target Commit:': '目標提交：',
    'Reset Type': '重設類型',
    'Soft (--soft)': '軟重設 (--soft)',
    'Keep all changes staged in the index. No file changes are lost.': '保留所有暫存區變更，不遺失任何檔案修改。',
    'Mixed (--mixed, Default)': '混合重設 (--mixed，預設)',
    'Keep all working tree changes unstaged. Index is reset.': '保留工作樹修改為未暫存狀態，重設暫存區。',
    'Hard (--hard)': '硬重設 (--hard)',
    'Discard all working tree and staged changes. Irreversible!': '捨棄所有工作樹與暫存區變更，不可逆！',
    'Reset': '重設',
    'Resetting...': '正在重設…',
    "Merge into '{branch}'": "合併到 '{branch}'",
    'Source Branch to Merge': '要合併的來源分支',
    'Merge Strategy': '合併策略',
    'Default (Fast-forward if possible, otherwise merge commit)': '預設（可快進則快進，否則建立合併提交）',
    'Always create merge commit (--no-ff)': '始終建立合併提交 (--no-ff)',
    'Squash merge (--squash)': '壓縮合併 (--squash)',
    'Fast-forward only (--ff-only)': '僅快進 (--ff-only)',
    'Custom Commit Message (Optional)': '自訂提交說明（選填）',
    'Merging...': '正在合併…',
    "Merge '{branch}'": "合併 '{branch}'",
  },
  fr: {
    'Reset Branch to Commit': 'Réinitialiser la branche sur le commit',
    'Target Commit:': 'Commit cible :',
    'Reset Type': 'Type de réinitialisation',
    'Soft (--soft)': 'Soft (--soft)',
    'Keep all changes staged in the index. No file changes are lost.': 'Garder toutes les modifications indexées. Aucune modification de fichier n’est perdue.',
    'Mixed (--mixed, Default)': 'Mixed (--mixed, Par défaut)',
    'Keep all working tree changes unstaged. Index is reset.': 'Garder les modifications du répertoire de travail non indexées. L’index est réinitialisé.',
    'Hard (--hard)': 'Hard (--hard)',
    'Discard all working tree and staged changes. Irreversible!': 'Abandonner toutes les modifications du répertoire et indexées. Irréversible !',
    'Reset': 'Réinitialiser',
    'Resetting...': 'Réinitialisation…',
    "Merge into '{branch}'": "Fusionner dans « {branch} »",
    'Source Branch to Merge': 'Branche source à fusionner',
    'Merge Strategy': 'Stratégie de fusion',
    'Default (Fast-forward if possible, otherwise merge commit)': 'Par défaut (Avance rapide si possible, sinon commit de fusion)',
    'Always create merge commit (--no-ff)': 'Toujours créer un commit de fusion (--no-ff)',
    'Squash merge (--squash)': 'Fusionner et condenser (--squash)',
    'Fast-forward only (--ff-only)': 'Avance rapide uniquement (--ff-only)',
    'Custom Commit Message (Optional)': 'Message de validation personnalisé (facultatif)',
    'Merging...': 'Fusion…',
    "Merge '{branch}'": "Fusionner « {branch} »",
  },
  ar: {
    'Reset Branch to Commit': 'إعادة تعيين الفرع إلى الالتزام',
    'Target Commit:': 'الالتزام المستهدف:',
    'Reset Type': 'نوع إعادة التعيين',
    'Soft (--soft)': 'ناعم (--soft)',
    'Keep all changes staged in the index. No file changes are lost.': 'الاحتفاظ بجميع التغييرات المجهّزة في الفهرس. لا تفقد أي تغييرات في الملفات.',
    'Mixed (--mixed, Default)': 'مختلط (--mixed، الافتراضي)',
    'Keep all working tree changes unstaged. Index is reset.': 'الاحتفاظ بجميع تغييرات شجرة العمل غير مجهّزة. تتم إعادة تعيين الفهرس.',
    'Hard (--hard)': 'صارم (--hard)',
    'Discard all working tree and staged changes. Irreversible!': 'تجاهل جميع تغييرات شجرة العمل والتغييرات المجهّزة. لا يمكن التراجع عن هذا!',
    'Reset': 'إعادة تعيين',
    'Resetting...': 'جارٍ إعادة التعيين…',
    "Merge into '{branch}'": "دمج في «{branch}»",
    'Source Branch to Merge': 'الفرع المصدر للدمج',
    'Merge Strategy': 'استراتيجية الدمج',
    'Default (Fast-forward if possible, otherwise merge commit)': 'افتراضي (تقديم سريع إذا أمكن، وإلا التزام دمج)',
    'Always create merge commit (--no-ff)': 'إنشاء التزام دمج دائماً (--no-ff)',
    'Squash merge (--squash)': 'دمج بالسحق (--squash)',
    'Fast-forward only (--ff-only)': 'تقديم سريع فقط (--ff-only)',
    'Custom Commit Message (Optional)': 'رسالة التزام مخصصة (اختيارية)',
    'Merging...': 'جارٍ الدمج…',
    "Merge '{branch}'": "دمج «{branch}»",
  },
};

for (const code of Object.keys(modalMessages) as Locale[]) {
  Object.assign(messages[code], modalMessages[code]);
}
...
const logPaginationTranslations: Record<Locale, MessageCatalog> = {
  en: {
    ...
    'Local changes conflict with target branch. Please commit or stash your changes first.': 'Local changes conflict with target branch. Please commit or stash your changes first.',
    'Smart Checkout': 'Smart Checkout',
    'Local changes conflict with target branch "{branch}". Would you like to perform a Smart Checkout? GitBX will stash your changes, switch to "{branch}", and reapply your changes.': 'Local changes conflict with target branch "{branch}". Would you like to perform a Smart Checkout? GitBX will stash your changes, switch to "{branch}", and reapply your changes.',
    'Smart Checkout Completed': 'Smart Checkout Completed',
    'Switched to "{branch}" and restored uncommitted changes.': 'Switched to "{branch}" and restored uncommitted changes.',
    'Smart Checkout Completed with Conflicts': 'Smart Checkout Completed with Conflicts',
    'Local changes were reapplied with conflicts. Please resolve them in the staging panel.': 'Local changes were reapplied with conflicts. Please resolve them in the staging panel.',
  },
  ja: {
    ...
    'Checkout Failed': 'ブランチのチェックアウトに失敗しました',
    'Local changes conflict with target branch. Please commit or stash your changes first.': '未コミットの変更が対象ブランチと競合しています。コミットまたはスタッシュを行ってから切り替えてください。',
    'Smart Checkout': 'スマートチェックアウト',
    'Local changes conflict with target branch "{branch}". Would you like to perform a Smart Checkout? GitBX will stash your changes, switch to "{branch}", and reapply your changes.': 'ローカルの変更が対象ブランチ「{branch}」と競合しています。スマートチェックアウトを実行しますか？変更を一時退避（スタッシュ）し、「{branch}」に切り替えた後に変更を復元します。',
    'Smart Checkout Completed': 'スマートチェックアウトが完了しました',
    'Switched to "{branch}" and restored uncommitted changes.': '「{branch}」に切り替え、未コミットの変更を復元しました。',
    'Smart Checkout Completed with Conflicts': 'スマートチェックアウトが完了しました（競合あり）',
    'Local changes were reapplied with conflicts. Please resolve them in the staging panel.': '変更の復元時に競合が発生しました。ステージングパネルで競合を解決してください。',
  },
  de: {
    ...
    'Checkout Failed': 'Auschecken fehlgeschlagen',
    'Local changes conflict with target branch. Please commit or stash your changes first.': 'Lokale Änderungen stehen im Konflikt mit dem Ziel-Branch. Bitte Änderungen zuerst committen oder stashen.',
    'Smart Checkout': 'Smart Checkout',
    'Local changes conflict with target branch "{branch}". Would you like to perform a Smart Checkout? GitBX will stash your changes, switch to "{branch}", and reapply your changes.': 'Lokale Änderungen stehen im Konflikt mit dem Ziel-Branch "{branch}". Möchten Sie einen Smart Checkout durchführen? GitBX wird Ihre Änderungen stashen, zu "{branch}" wechseln und die Änderungen wieder anwenden.',
    'Smart Checkout Completed': 'Smart Checkout abgeschlossen',
    'Switched to "{branch}" and restored uncommitted changes.': 'Zu "{branch}" gewechselt und nicht committete Änderungen wiederhergestellt.',
    'Smart Checkout Completed with Conflicts': 'Smart Checkout mit Konflikten abgeschlossen',
    'Local changes were reapplied with conflicts. Please resolve them in the staging panel.': 'Änderungen wurden mit Konflikten angewendet. Bitte im Bereitstellungsbereich lösen.',
  },
  es: {
    ...
    'Checkout Failed': 'Error al cambiar de rama',
    'Local changes conflict with target branch. Please commit or stash your changes first.': 'Los cambios locales entran en conflicto con la rama de destino. Confirme o guarde (stash) los cambios antes de cambiar.',
    'Smart Checkout': 'Smart Checkout',
    'Local changes conflict with target branch "{branch}". Would you like to perform a Smart Checkout? GitBX will stash your changes, switch to "{branch}", and reapply your changes.': 'Los cambios locales entran en conflicto con la rama "{branch}". ¿Desea realizar un Smart Checkout? GitBX guardará sus cambios, cambiará a "{branch}" y los volverá a aplicar.',
    'Smart Checkout Completed': 'Smart Checkout completado',
    'Switched to "{branch}" and restored uncommitted changes.': 'Se cambió a "{branch}" y se restauraron los cambios no confirmados.',
    'Smart Checkout Completed with Conflicts': 'Smart Checkout completado con conflictos',
    'Local changes were reapplied with conflicts. Please resolve them in the staging panel.': 'Los cambios se volvieron a aplicar con conflictos. Resuélvalos en el panel de preparación.',
  },
  'zh-CN': {
    ...
    'Checkout Failed': '检出分支失败',
    'Local changes conflict with target branch. Please commit or stash your changes first.': '本地存在未提交的修改与目标分支冲突，请先提交或贮藏(Stash)修改后再切换分支。',
    'Smart Checkout': '智能检出',
    'Local changes conflict with target branch "{branch}". Would you like to perform a Smart Checkout? GitBX will stash your changes, switch to "{branch}", and reapply your changes.': '本地存在未提交的修改与目标分支 "{branch}" 冲突。是否使用【智能检出】？GitBX 将自动暂存当前改动，切换到 "{branch}" 后再恢复改动。',
    'Smart Checkout Completed': '智能检出成功',
    'Switched to "{branch}" and restored uncommitted changes.': '已切换到分支 "{branch}" 并还原本地未提交修改。',
    'Smart Checkout Completed with Conflicts': '智能检出完成（存在冲突）',
    'Local changes were reapplied with conflicts. Please resolve them in the staging panel.': '本地修改恢复时存在冲突，请在暂存区解决合并冲突。',
  },
  'zh-TW': {
    ...
    'Checkout Failed': '簽出分支失敗',
    'Local changes conflict with target branch. Please commit or stash your changes first.': '本地存在未提交的修改與目標分支衝突，請先提交或暫存(Stash)修改後再切換分支。',
    'Smart Checkout': '智慧簽出',
    'Local changes conflict with target branch "{branch}". Would you like to perform a Smart Checkout? GitBX will stash your changes, switch to "{branch}", and reapply your changes.': '本地存在未提交的修改與目標分支 "{branch}" 衝突。是否使用【智慧簽出】？GitBX 將自動暫存當前改動，切換到 "{branch}" 後再還原改动。',
    'Smart Checkout Completed': '智慧簽出成功',
    'Switched to "{branch}" and restored uncommitted changes.': '已切換到分支 "{branch}" 並還原本地未提交修改。',
    'Smart Checkout Completed with Conflicts': '智慧簽出完成（存在衝突）',
    'Local changes were reapplied with conflicts. Please resolve them in the staging panel.': '本地修改還原時存在衝突，請在暫存區解決合併衝突。',
  },
  fr: {
    ...
    'Checkout Failed': 'Échec de l’extraction de la branche',
    'Local changes conflict with target branch. Please commit or stash your changes first.': 'Les modifications locales sont en conflit avec la branche cible. Veuillez commiter ou remiser vos modifications avant de changer.',
    'Smart Checkout': 'Extraction intelligente',
    'Local changes conflict with target branch "{branch}". Would you like to perform a Smart Checkout? GitBX will stash your changes, switch to "{branch}", and reapply your changes.': 'Les modifications locales sont en conflit avec la branche cible « {branch} ». Souhaitez-vous effectuer une extraction intelligente ? GitBX va remiser vos modifications, basculer sur « {branch} » et les réappliquer.',
    'Smart Checkout Completed': 'Extraction intelligente terminée',
    'Switched to "{branch}" and restored uncommitted changes.': 'Basculé sur « {branch} » et restauré les modifications non commitées.',
    'Smart Checkout Completed with Conflicts': 'Extraction intelligente terminée avec des conflits',
    'Local changes were reapplied with conflicts. Please resolve them in the staging panel.': 'Les modifications ont été réappliquées avec des conflits. Veuillez les résoudre dans le panneau d’indexation.',
  },
  ar: {
    ...
    'Checkout Failed': 'فشل التبديل إلى الفرع',
    'Local changes conflict with target branch. Please commit or stash your changes first.': 'التغييرات المحلية تتعارض مع الفرع المستهدف. يرجى إيداع أو تخزين التغييرات مؤقتاً قبل التبديل.',
    'Smart Checkout': 'التبديل الذكي',
    'Local changes conflict with target branch "{branch}". Would you like to perform a Smart Checkout? GitBX will stash your changes, switch to "{branch}", and reapply your changes.': 'التغييرات المحلية تتعارض مع الفرع المستهدف "{branch}". هل ترغب في إجراء تبديل ذكي؟ سيقوم GitBX بتخزين تغييراتك مؤقتاً، والتبديل إلى "{branch}"، ثم إعادة تطبيقها.',
    'Smart Checkout Completed': 'اكتمل التبديل الذكي',
    'Switched to "{branch}" and restored uncommitted changes.': 'تم التبديل إلى "{branch}" واستعادة التغييرات غير المودعة.',
    'Smart Checkout Completed with Conflicts': 'اكتمل التبديل الذكي مع وجود تعارضات',
    'Local changes were reapplied with conflicts. Please resolve them in the staging panel.': 'تمت إعادة تطبيق التغييرات مع وجود تعارضات. يرجى حلها في لوحة الترحيل.',
  },
};
...
const pushRecoveryTranslations: Record<Locale, MessageCatalog> = {
  en: { 'Remote Branch Has New Commits': 'Remote Branch Has New Commits', 'Continue Push': 'Continue Push', 'Pull and Push': 'Pull and Push', 'Pull remote changes into the current branch, then retry the push? If conflicts occur, resolve them before pushing again.': 'Pull remote changes into the current branch, then retry the push? If conflicts occur, resolve them before pushing again.', 'Fetch the latest remote state, then replace the remote branch with your local branch? Commits that exist only on the remote will be removed.': 'Fetch the latest remote state, then replace the remote branch with your local branch? Commits that exist only on the remote will be removed.' },
  ja: { 'Remote Branch Has New Commits': 'リモートブランチに新しいコミットがあります', 'Continue Push': 'プッシュを続行', 'Pull and Push': 'PullしてPush', 'Pull remote changes into the current branch, then retry the push? If conflicts occur, resolve them before pushing again.': 'リモートの変更を現在のブランチにPullしてからPushを再試行しますか？競合が発生した場合は、解決してから再度Pushしてください。', 'Fetch the latest remote state, then replace the remote branch with your local branch? Commits that exist only on the remote will be removed.': '最新のリモート状態を取得してから、リモートブランチをローカルブランチで置き換えますか？リモートにしかないコミットは削除されます。' },
  de: { 'Remote Branch Has New Commits': 'Remote-Branch enthält neue Commits', 'Continue Push': 'Push fortsetzen', 'Pull and Push': 'Pullen und pushen', 'Pull remote changes into the current branch, then retry the push? If conflicts occur, resolve them before pushing again.': 'Remote-Änderungen in den aktuellen Branch pullen und den Push erneut versuchen? Konflikte müssen vor einem weiteren Push gelöst werden.', 'Fetch the latest remote state, then replace the remote branch with your local branch? Commits that exist only on the remote will be removed.': 'Den neuesten Remote-Stand abrufen und anschließend den Remote-Branch durch den lokalen Branch ersetzen? Commits, die nur im Remote vorhanden sind, werden entfernt.' },
  es: { 'Remote Branch Has New Commits': 'La rama remota tiene commits nuevos', 'Continue Push': 'Continuar Push', 'Pull and Push': 'Pull y Push', 'Pull remote changes into the current branch, then retry the push? If conflicts occur, resolve them before pushing again.': '¿Incorporar los cambios remotos en la rama actual y reintentar el Push? Si hay conflictos, resuélvelos antes de volver a enviar.', 'Fetch the latest remote state, then replace the remote branch with your local branch? Commits that exist only on the remote will be removed.': '¿Obtener el estado remoto más reciente y reemplazar la rama remota por la rama local? Se eliminarán los commits que solo existan en el remoto.' },
  'zh-CN': { 'Remote Branch Has New Commits': '远端分支有新的提交', 'Continue Push': '继续推送', 'Pull and Push': '拉取并推送', 'Pull remote changes into the current branch, then retry the push? If conflicts occur, resolve them before pushing again.': '先将远端更改拉取到当前分支，再重试推送？如果产生冲突，请解决后再次推送。', 'Fetch the latest remote state, then replace the remote branch with your local branch? Commits that exist only on the remote will be removed.': '是否先获取最新远端状态，再用本地分支替换远端分支？仅存在于远端的提交将被移除。' },
  'zh-TW': { 'Remote Branch Has New Commits': '遠端分支有新的提交', 'Continue Push': '繼續推送', 'Pull and Push': '拉取並推送', 'Pull remote changes into the current branch, then retry the push? If conflicts occur, resolve them before pushing again.': '先將遠端變更拉取到目前分支，再重試推送？若產生衝突，請解決後再次推送。', 'Fetch the latest remote state, then replace the remote branch with your local branch? Commits that exist only on the remote will be removed.': '是否先取得最新遠端狀態，再用本機分支取代遠端分支？僅存在於遠端的提交將被移除。' },
  fr: { 'Remote Branch Has New Commits': 'La branche distante contient de nouveaux commits', 'Continue Push': 'Continuer l’envoi', 'Pull and Push': 'Pull puis Push', 'Pull remote changes into the current branch, then retry the push? If conflicts occur, resolve them before pushing again.': 'Récupérer les changements distants dans la branche actuelle, puis réessayer le Push ? En cas de conflits, résolvez-les avant de réessayer.', 'Fetch the latest remote state, then replace the remote branch with your local branch? Commits that exist only on the remote will be removed.': 'Récupérer le dernier état distant, puis remplacer la branche distante par la branche locale ? Les commits présents uniquement à distance seront supprimés.' },
  ar: { 'Remote Branch Has New Commits': 'يحتوي الفرع البعيد على التزامات جديدة', 'Continue Push': 'متابعة الدفع', 'Pull and Push': 'السحب ثم الدفع', 'Pull remote changes into the current branch, then retry the push? If conflicts occur, resolve them before pushing again.': 'هل تريد سحب التغييرات البعيدة إلى الفرع الحالي ثم إعادة محاولة الدفع؟ إذا ظهرت تعارضات، فحلّها قبل الدفع مرة أخرى.', 'Fetch the latest remote state, then replace the remote branch with your local branch? Commits that exist only on the remote will be removed.': 'هل تريد جلب أحدث حالة للفرع البعيد ثم استبداله بالفرع المحلي؟ ستتم إزالة الالتزامات الموجودة في الفرع البعيد فقط.' },
};
...
const smartCheckoutTranslations: Record<Locale, MessageCatalog> = {
  en: { 'Branch Switched': 'Branch Switched', "Switched to branch '{branch}'.": "Switched to branch '{branch}'.", 'Failed to switch branch': 'Failed to switch branch', 'Local Changes Would Be Overwritten': 'Local Changes Would Be Overwritten', "Switching to '{branch}' would overwrite local changes. Smart Checkout will temporarily stash all changes, switch branches, and restore them on the target branch.": "Switching to '{branch}' would overwrite local changes. Smart Checkout will temporarily stash all changes, switch branches, and restore them on the target branch.", 'Smart Checkout': 'Smart Checkout', 'Branch Switched with Conflicts': 'Branch Switched with Conflicts', 'Local changes were restored with conflicts. A backup remains in Stashes until you finish resolving them.': 'Local changes were restored with conflicts. A backup remains in Stashes until you finish resolving them.', 'Local changes were restored with conflicts.': 'Local changes were restored with conflicts.', 'Smart Checkout Complete': 'Smart Checkout Complete', "Switched to branch '{branch}' and restored local changes.": "Switched to branch '{branch}' and restored local changes.", 'Smart Checkout Failed': 'Smart Checkout Failed' },
  ja: { 'Branch Switched': 'ブランチを切り替えました', 'Failed to switch branch': 'ブランチの切り替えに失敗しました', 'Local Changes Would Be Overwritten': 'ローカル変更が上書きされます', 'Smart Checkout': 'スマートチェックアウト', 'Branch Switched with Conflicts': '競合を伴ってブランチを切り替えました', 'Smart Checkout Complete': 'スマートチェックアウト完了', 'Smart Checkout Failed': 'スマートチェックアウトに失敗しました' },
  de: { 'Branch Switched': 'Branch gewechselt', 'Failed to switch branch': 'Branch konnte nicht gewechselt werden', 'Local Changes Would Be Overwritten': 'Lokale Änderungen würden überschrieben', 'Smart Checkout': 'Smart Checkout', 'Branch Switched with Conflicts': 'Branch mit Konflikten gewechselt', 'Smart Checkout Complete': 'Smart Checkout abgeschlossen', 'Smart Checkout Failed': 'Smart Checkout fehlgeschlagen' },
  es: { 'Branch Switched': 'Rama cambiada', 'Failed to switch branch': 'No se pudo cambiar de rama', 'Local Changes Would Be Overwritten': 'Los cambios locales se sobrescribirían', 'Smart Checkout': 'Cambio inteligente', 'Branch Switched with Conflicts': 'Rama cambiada con conflictos', 'Smart Checkout Complete': 'Cambio inteligente completado', 'Smart Checkout Failed': 'Falló el cambio inteligente' },
  'zh-CN': { 'Branch Switched': '分支已切换', "Switched to branch '{branch}'.": "已切换到分支“{branch}”。", 'Failed to switch branch': '切换分支失败', 'Local Changes Would Be Overwritten': '本地修改将被覆盖', "Switching to '{branch}' would overwrite local changes. Smart Checkout will temporarily stash all changes, switch branches, and restore them on the target branch.": "切换到“{branch}”会覆盖本地修改。智能切换将临时储藏全部修改，切换分支后再恢复到目标分支。", 'Smart Checkout': '智能切换', 'Branch Switched with Conflicts': '分支已切换，但存在冲突', 'Local changes were restored with conflicts. A backup remains in Stashes until you finish resolving them.': '本地修改恢复时产生冲突。解决完成前，储藏中会保留一份安全备份。', 'Local changes were restored with conflicts.': '本地修改恢复时产生冲突。', 'Smart Checkout Complete': '智能切换完成', "Switched to branch '{branch}' and restored local changes.": "已切换到分支“{branch}”并恢复本地修改。", 'Smart Checkout Failed': '智能切换失败' },
  'zh-TW': { 'Branch Switched': '分支已切換', 'Failed to switch branch': '切換分支失敗', 'Local Changes Would Be Overwritten': '本機修改將被覆寫', 'Smart Checkout': '智慧切換', 'Branch Switched with Conflicts': '分支已切換，但存在衝突', 'Smart Checkout Complete': '智慧切換完成', 'Smart Checkout Failed': '智慧切換失敗' },
  fr: { 'Branch Switched': 'Branche changée', 'Failed to switch branch': 'Échec du changement de branche', 'Local Changes Would Be Overwritten': 'Les modifications locales seraient écrasées', 'Smart Checkout': 'Changement intelligent', 'Branch Switched with Conflicts': 'Branche changée avec des conflits', 'Smart Checkout Complete': 'Changement intelligent terminé', 'Smart Checkout Failed': 'Échec du changement intelligent' },
  ar: { 'Branch Switched': 'تم تبديل الفرع', 'Failed to switch branch': 'فشل تبديل الفرع', 'Local Changes Would Be Overwritten': 'سيتم استبدال التغييرات المحلية', 'Smart Checkout': 'التبديل الذكي', 'Branch Switched with Conflicts': 'تم تبديل الفرع مع وجود تعارضات', 'Smart Checkout Complete': 'اكتمل التبديل الذكي', 'Smart Checkout Failed': 'فشل التبديل الذكي' },
};
